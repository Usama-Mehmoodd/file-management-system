  ...
  return (
    <div className="fms-page">
      <style>{`
        ...
        .fms-doc.d1 { top: 10%; right: 9%; transform: rotate(12deg); background: var(--paper); opacity: 0.05; }
        .fms-doc.d2 { bottom: 8%; right: 6%; transform: rotate(-9deg); width: 150px; height: 195px; }
        .fms-doc.d3 { top: 10%; left: 8%; transform: rotate(-13deg); width: 165px; height: 215px; background: var(--amber); opacity: 0.08; }
        .fms-doc.d4 { bottom: 6%; left: 12%; transform: rotate(7deg); }
